...
Click here for [Documentation](https://github.com/ankitpokhrel/Dynamic-Featured-Image "Documentation")
...
== Screenshots == 
1. New featured image.
2. Selecting images from media box.
3. Add new featured image.
